...
[tickets](https://github.com/craterdog/go-package-framework/issues)
...
following:
 ...
 1. Make sure that all code changes and new code meet the coding conventions for
    the [class framework](https://github.com/craterdog/go-package-framework/wiki)
...
[discussion area](https://github.com/craterdog/go-package-framework/discussions)
for this project.
